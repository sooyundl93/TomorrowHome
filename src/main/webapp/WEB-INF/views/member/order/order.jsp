...
<div id="container">
    ...
    <form action="orderAction" method="post" class="join2">       
        <!--*****************-->
        <!--* 주문정보 메인 *-->
        <!--*****************-->
        <div class="item_table">
            ...
            <!-- 주문한 상품 정보 -->
            <c:forEach var="user_cart_list" items="${ user_cart_list }">
            <div class="item_tr">            
                <div class="item_td">
                    <img src="/products/${ user_cart_list.image_file_name }" alt="상품 이미지">
                </div>
                
                <div class="item_text">
                    <div class="item_td">
                        ${ user_cart_list.product_name }
                    </div>
                    <div class="item_td">
                        ${ user_cart_list.number_of_products }개
                    </div>
                    <div class="item_td">
                        <fmt:formatNumber value="${ user_cart_list.product_total_price }" pattern="#,###"/>원
                    </div>
                </div>            
            </div>
            </c:forEach>
        ...
        <div class="table">
            ...
            <div class="tr">
                ...
                <div class="td">
                    <div class="upper">
                        <input type="text" id="sample6_postcode"  name="postal_code" value="${ member_info.postal_code }" readonly>
                        <a href="javascript:sample6_execDaumPostcode()">주소 검색</a>
                    </div>
                    
                    <input type="text" id="sample6_address" name="address" value="${ member_info.address }">
            ...
            <div class="tr">
                ...
                <div class="td">
                    <input type="text" max-length="6" name="shipping_memo">
                </div>
            </div>     
        </div>
