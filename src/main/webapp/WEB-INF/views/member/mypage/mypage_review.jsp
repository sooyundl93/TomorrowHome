...
<%@ page import="com.study.springboot.dto.Member_reviewDto " %>
<%@ page import="java.util.ArrayList"%>

<%
	List<Member_reviewDto> list = (List<Member_reviewDto>)request.getAttribute("list");
...
<div id="container">
    ...
    <div class="content">
        ...
        <div class="aside">
            ...
            <div class="aside_menu"><a href="product_review" class="current">상품리뷰</a></div>
        ...
        <div class="board one2one">      
            ...
            <!-- 기간별 조회 -->
            <form action="review_date_search" method="post">
                <div class="search_date">
                    ...
                    <div class="datepicker">
                        ...
                        <input type="text" id="start_datepicker" name="start_date" required readonly>
                        <span>~</span>
                        <input type="text" name="end_date"  id="end_datepicker" required readonly>
                        <!-- 조회 버튼 -->  
            ...
            <div class="contents" id="contents">  
                ...
                <div class="table_count">
                    <div class="table_caption" id="table_caption">
                        상품리뷰&nbsp;<strong class="count_number"><c:out value="${  count2 }"/></strong>건
                    </div>              
                </div>
                ...
                <div class="table">                
                    <div class="th">
                        ...
                        <div class="inquiry_answer">별점</div>
                    ...
                    <c:forEach var="dto2" items="${  list }">
                        <div class="td">
                            ...
                            <div class="inquiry_content">
                                <a href="#" 
                                onclick="window.open('product_review_popup?post_no=${ dto2.post_no}','window_name','width=800,height=400,location=no,status=no,scrollbars=yes');">${ dto2.post_content }</a>
                            </div>
                            
                            <!-- 별점 -->
                            <div class="inquiry_answer">${ dto2.review_score }</div>
                            
                            <!-- 리뷰 삭제 버튼 -->
                            <div class="inquiry_delete">
                                <a href="product_review_delete?post_no=${ dto2.post_no }">
                ...
                <div class="product_gallery">
                    <c:forEach var="i" begin="1" end="${ count }">
                        <a href="review_date_search?page=${ i }&start_date=${ startdate }&end_date=${ enddate}" class="paging">${ i } </a>&nbsp;&nbsp;
                    </c:forEach>
                </div>              
            </div>      
        </div>        
