...
<body>
    ...
    <div class="review_popup">    
    	...
    	<form action="product_review_write_action" method="post" enctype="multipart/form-data">
            <div class="review">   	    	
                <!-- 이미지 -->
                <div class="imgwrap">            
                    <div class="imgtop">
                ...
                <div class="textwrap">	 
                    ...
                    <div class="text_content">
                        <textarea cols="58" rows="8" id="post_content" name="post_content" maxlength="500"
                        placeholder="500자 이내로 입력해주세요" required></textarea>
                    </div>	
                    ...
                    <div class="popup">
                        <div class="review_button">
                            <input type="submit" class="btn_blue" value="리뷰쓰기" />
                        </div>
                    </div>                        
                </div>
            </div>
