...
<%@ page import="com.study.springboot.dto.One2one_inquiryDto" %>
<%@ page import="java.util.List"%>
<%@ page import="java.util.ArrayList"%>
 
<%
	List<One2one_inquiryDto> list = (List<One2one_inquiryDto>)request.getAttribute("list");
    ...
    <div class="page_title">                    
        ...
        <div class="breadcrumb">
            <div class="location_content">
                ...
                <span class="current">1:1 문의</span>
            </div>
        </div>
        <div class="line"></div>
    </div>
    ...
    <div class="content">       
        <!-- 사이드바 -->
         <div class="aside">
            ...
            <div class="aside_menu"><a href="one2one_inquiry" class="current">1:1 문의</a></div>
        ...
        <div class="board one2one">                       
            ...
            <!-- 기간별 조회 -->
            <form action="one2one_date_search" method="post">
            ...
            <div class="contents" id="contents">  
                ...
                <div class="table_count">
                    <div class="table_caption" id="table_caption">
                        1:1 문의 &nbsp;<strong class="count_number"><c:out value="${ count2 }"/></strong>건
                    </div>
                    <span>최근 30일 내에 문의하신 내역입니다</span>
                    
                    <!-- 문의하기 버튼 -->  
                    <button type="button" class="inquiry_button button"
                    ...
                    <c:forEach var="dto2" items="${ list }">
                        <div class="td">
                            ...
                            <div class="inquiry_subject">
                                <a href="#"
                                onclick="window.open('one2one_popup?inquiry_no=${ dto2.inquiry_no }',
                                'window_name','width=480, height=600, location=no, status=no, scrollbars=yes');">
                                    ${ dto2.inquiry_title }
                                </a>
                            </div>
                            
                            <!-- 문의 내용 -->
                            <div class="inquiry_content">${ dto2.inquiry_content }</div>
                            
                            <!-- 문의글 답변 수 -->
                            <div class="inquiry_answer">
                                ${ dto2.number_of_replies }
                            </div>
                            
                            <!-- 문의글 삭제 버튼 -->
                            <div class="inquiry_delete">
                                <a href="one2one_delete?inquiry_no=${ dto2.inquiry_no }">
                ...
                <div class="product_gallery">
                    <c:forEach var="i" begin="1" end="${ count }">
                        <a href="one2one_date_search?page=${ i }&start_date=${ startdate }&end_date=${ enddate }" class="paging">${ i }</a>&nbsp;&nbsp;
                    </c:forEach>
                </div>
            </div>
        </div>
...
<script>
    ...
    function inquiry_button(){  
        window.open("one2one_write_popup", "1:1문의", "width=480, height=600, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
    }  
    
    function withDraw(){  
        window.open("withDraw", "회원탈퇴", "width=480, height=600, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
    }  
</script>